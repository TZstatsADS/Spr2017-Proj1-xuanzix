---
title: "What Can We See From Inaugural Addresses"
output:
...
packages.used=c("rvest", "tibble", "qdap", 
                ...
                "RANN", "tm", "topicmodels","DT","languageR","NLP","openNLP","magrittr","ggplot2","tidytext","wordcloud","grid","gridExtra")
...
Two reasons can be considered reasonable. First, Trump wants to show citizens a different personal style compared with those Presidents known as famous politicians. Actually, this is one of the reasons why he could get such a huge amount of supporters. From the inauguration speech, he has already started his plan making some changes in this country. Second, Trump is a business man but not a politician, he does not have much experience giving speech in front of such a big crowd. So, he shortened his sentence and reduced his vocabulary in order to avoid mistakes. In the following parts, considering about the sentimental analysis, there are more reasons to explain his short inauguration speech.

### Let's focus on the shift in inauguration speeches
...
However, if looking at the number of sentences and the average words per sentence, we find that sentences in the inauguration speech have been longer and the average words per sentence have been smaller and smaller. That might because the pace of life turning more and more quick, people have already got used to reading short sentences posted on all kinds of social apps rather than reading newspapers and long sentences. As a result, people prefer shorter sentences when they listen to other people. The inauguration speech cannot escape from this trend. So, the pace of the speech has been faster and faster.
...
### What words did presidents like to say?
...
The word cloud technology shows us what did a President say much during the speech. First, President Clinton, who won the competition against George Bush. As a young politician at that time, he focused on economic revolution. So in his inauguration speech, we can see words like renewal, today, raise, and so on. 
...
Finally, President Trump has been focusing on solving the employment problem and protecting domestic workers before he won the presidential election. So during his inauguration speech, we see words like jobs, dreams, everyone factories, protected, etc.

In a word, through the word cloud, we can see clearly what a President want to do in his term of office and also his character sometimes.
...
As mentioned before, recent Presidents prefer to the word America. From the figure above, beginning from President Roosevelt, the number of the word America has increased in a high speed. President Trump has said this word for about 35 times in the inauguration speech. It is a good way to win people's hearts. More important, this is a good way to let citizens feel proud of their home country. 
...
Both President Trump and Obama ended their speech in a positive emotion since in the recent decade, America did not be caught in any serious international trouble. All the major problems were from the country itself. For instance, during Trump's speech, he said: For too long, a small group in our nation's capital has reaped the rewards of government while the people have borne the cost. But finally, he drew a beautiful picture of the country's future to every American. From the figure, at the end of his speech, the positive emotion went to the highest point. 
```{r, echo=FALSE, fig.height=5, fig.width=10, message=FALSE, warning=FALSE}
par(mfrow=c(1,2))
...
To sum up, the sentiment analysis demonstrates the President's attitude towards the future of this country.
